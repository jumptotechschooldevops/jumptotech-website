...
export const modules: Module[] = [
  {
    ...
    totalHours: 6,
    lectures: [
      { id: "git-1", title: "Introduction to Version Control", duration: "22 min", type: "video", description: "Why version control matters, history of Git, and core concepts." },
      { id: "git-2", title: "Git Internals: Objects & Refs", duration: "35 min", type: "video", description: "Blobs, trees, commits, and how Git stores data under the hood." },
      { id: "git-3", title: "Branching Strategies", duration: "28 min", type: "video", description: "GitFlow, trunk-based development, and feature branching workflows." },
      { id: "git-4", title: "Rebasing vs Merging", duration: "20 min", type: "video", description: "When to rebase, when to merge, and how to keep a clean history." },
      { id: "git-5", title: "Advanced Git Commands", duration: "30 min", type: "video", description: "Cherry-pick, bisect, stash, reflog, and other power-user tools." },
      { id: "git-6", title: "GitHub Pull Request Workflow", duration: "25 min", type: "video", description: "Code reviews, PR templates, and CI/CD integration with GitHub." },
  ...
  },
  {
    ...
    totalHours: 9,
    lectures: [
      { id: "linux-1", title: "Linux Filesystem Hierarchy", duration: "25 min", type: "video", description: "Understanding /etc, /var, /usr, /opt and the FHS standard." },
      { id: "linux-2", title: "Process Management", duration: "30 min", type: "video", description: "ps, top, htop, kill, nice, and process priorities." },
      { id: "linux-3", title: "User & Permission Management", duration: "28 min", type: "video", description: "Users, groups, chmod, chown, ACLs, and sudo configuration." },
      { id: "linux-4", title: "Networking Fundamentals", duration: "35 min", type: "video", description: "ip, ss, netstat, firewalld, iptables, and network troubleshooting." },
      { id: "linux-5", title: "Package Management", duration: "20 min", type: "video", description: "apt, yum/dnf, rpm, snap, and managing software repositories." },
      { id: "linux-6", title: "Systemd & Services", duration: "32 min", type: "video", description: "systemctl, journald, service units, and boot process." },
      { id: "linux-7", title: "Bash Scripting Essentials", duration: "40 min", type: "video", description: "Variables, loops, functions, error handling, and best practices." },
      ...
      { id: "linux-10", title: "Security Hardening", duration: "35 min", type: "video", description: "SSH hardening, SELinux/AppArmor, CIS benchmarks." },
    ],
    labs: [
  ...
  },
  {
    ...
    totalHours: 8,
    lectures: [
      { id: "net-1", title: "OSI & TCP/IP Models", duration: "30 min", type: "video", description: "Layers, encapsulation, and how data travels across networks." },
      { id: "net-2", title: "IP Addressing & Subnetting", duration: "35 min", type: "video", description: "IPv4, IPv6, CIDR notation, and subnet calculations." },
      { id: "net-3", title: "DNS Deep Dive", duration: "28 min", type: "video", description: "Resolution process, record types, DNS security, and troubleshooting." },
      { id: "net-4", title: "HTTP/HTTPS & TLS", duration: "32 min", type: "video", description: "HTTP methods, headers, status codes, TLS handshake, and certificates." },
      { id: "net-5", title: "Load Balancing Strategies", duration: "25 min", type: "video", description: "Round robin, least connections, health checks, and sticky sessions." },
      { id: "net-6", title: "Firewalls & Network Security", duration: "30 min", type: "video", description: "Stateful firewalls, WAF, DDoS protection, and network segmentation." },
      ...
      { id: "net-8", title: "Service Mesh & mTLS", duration: "28 min", type: "video", description: "Istio, Envoy, mutual TLS, and East-West traffic in Kubernetes." },
  ...
  },
  {
    ...
    totalHours: 10,
    lectures: [
      { id: "docker-1", title: "Container Fundamentals", duration: "25 min", type: "video", description: "Namespaces, cgroups, and how containers differ from VMs." },
      { id: "docker-2", title: "Dockerfile Best Practices", duration: "35 min", type: "video", description: "Layer caching, multi-stage builds, and minimal base images." },
      { id: "docker-3", title: "Docker Networking", duration: "28 min", type: "video", description: "Bridge, host, overlay networks, and service discovery." },
      { id: "docker-4", title: "Volumes & Persistent Storage", duration: "22 min", type: "video", description: "Named volumes, bind mounts, and storage drivers." },
      { id: "docker-5", title: "Docker Compose", duration: "30 min", type: "video", description: "Multi-container applications, dependencies, and profiles." },
      { id: "docker-6", title: "Container Security", duration: "35 min", type: "video", description: "Non-root users, read-only filesystems, secrets, and image scanning." },
      { id: "docker-7", title: "Registry & Image Management", duration: "20 min", type: "video", description: "Docker Hub, private registries, image tagging, and versioning." },
      ...
      { id: "docker-9", title: "Docker Swarm Basics", duration: "28 min", type: "video", description: "Services, stacks, replicas, and rolling updates." },
  ...
  },
  {
    ...
    totalHours: 16,
    lectures: [
      { id: "k8s-1", title: "Kubernetes Architecture", duration: "35 min", type: "video", description: "Control plane, nodes, etcd, API server, scheduler, and kubelet." },
      { id: "k8s-2", title: "Pods & Workloads", duration: "30 min", type: "video", description: "Pods, Deployments, StatefulSets, DaemonSets, and Jobs." },
      { id: "k8s-3", title: "Services & Networking", duration: "32 min", type: "video", description: "ClusterIP, NodePort, LoadBalancer, Ingress, and NetworkPolicies." },
      { id: "k8s-4", title: "Configuration & Secrets", duration: "25 min", type: "video", description: "ConfigMaps, Secrets, environment variables, and volume mounts." },
      { id: "k8s-5", title: "Persistent Storage", duration: "28 min", type: "video", description: "PV, PVC, StorageClasses, and CSI drivers." },
      { id: "k8s-6", title: "RBAC & Security", duration: "35 min", type: "video", description: "Roles, ClusterRoles, ServiceAccounts, PodSecurityStandards." },
      { id: "k8s-7", title: "Resource Management", duration: "22 min", type: "video", description: "Requests, limits, LimitRanges, ResourceQuotas, and VPA/HPA." },
      { id: "k8s-8", title: "Helm Package Manager", duration: "30 min", type: "video", description: "Charts, values, templating, and managing releases." },
      { id: "k8s-9", title: "Ingress Controllers", duration: "28 min", type: "video", description: "nginx Ingress, TLS termination, path routing, and annotations." },
      { id: "k8s-10", title: "Rolling Updates & Rollbacks", duration: "20 min", type: "video", description: "Deployment strategies, canary, blue/green, and rollbacks." },
      { id: "k8s-11", title: "Cluster Autoscaling", duration: "25 min", type: "reading", description: "HPA, VPA, KEDA, and Cluster Autoscaler." },
      { id: "k8s-12", title: "Operators & CRDs", duration: "32 min", type: "video", description: "Custom resources, controller pattern, and popular operators." },
      { id: "k8s-13", title: "GitOps with ArgoCD", duration: "35 min", type: "video", description: "ArgoCD setup, application sync, and GitOps workflows." },
  ...
  },
  {
    ...
    totalHours: 9,
    lectures: [
      { id: "cicd-1", title: "CI/CD Principles & Pipelines", duration: "25 min", type: "video", description: "Continuous integration, delivery, deployment — and why they matter." },
      { id: "cicd-2", title: "GitHub Actions Deep Dive", duration: "40 min", type: "video", description: "Workflows, jobs, steps, runners, secrets, and reusable workflows." },
      { id: "cicd-3", title: "GitLab CI/CD", duration: "35 min", type: "video", description: "Stages, jobs, artifacts, caches, and GitLab-specific features." },
      { id: "cicd-4", title: "Jenkins Pipelines", duration: "32 min", type: "video", description: "Declarative vs scripted pipelines, shared libraries, and plugins." },
      { id: "cicd-5", title: "Testing in CI", duration: "28 min", type: "video", description: "Unit, integration, E2E testing, coverage gates, and parallelization." },
      { id: "cicd-6", title: "Docker Build in CI", duration: "22 min", type: "video", description: "Building, scanning, and pushing images in CI pipelines." },
      { id: "cicd-7", title: "Deployment Strategies", duration: "30 min", type: "video", description: "Blue/green, canary, rolling, and feature flags in CD." },
  ...
  },
  {
    ...
    totalHours: 10,
    lectures: [
      { id: "tf-1", title: "IaC Concepts & Terraform Basics", duration: "28 min", type: "video", description: "Why IaC, Terraform vs alternatives, HCL syntax, and init/plan/apply." },
      { id: "tf-2", title: "Providers & Resources", duration: "32 min", type: "video", description: "AWS/Azure/GCP providers, resource lifecycle, and meta-arguments." },
      { id: "tf-3", title: "Variables & Outputs", duration: "22 min", type: "video", description: "Input variables, local values, output values, and tfvars files." },
      { id: "tf-4", title: "State Management", duration: "30 min", type: "video", description: "Local vs remote state, S3 backends, state locking, and import." },
      { id: "tf-5", title: "Modules", duration: "35 min", type: "video", description: "Writing reusable modules, module registry, and versioning." },
      { id: "tf-6", title: "Workspaces & Environments", duration: "22 min", type: "video", description: "Multi-environment strategy, workspaces, and directory structure." },
      { id: "tf-7", title: "Terraform with CI/CD", duration: "28 min", type: "video", description: "Atlantis, Terraform Cloud, and pipeline integration." },
      ...
      { id: "tf-10", title: "Drift Detection & Refactoring", duration: "20 min", type: "video", description: "Detecting configuration drift and safely refactoring state." },
    ],
    labs: [
  ...
  },
  {
    ...
    totalHours: 9,
    lectures: [
      { id: "mon-1", title: "Observability Pillars", duration: "20 min", type: "video", description: "Metrics, logs, and traces — the three pillars explained." },
      { id: "mon-2", title: "Prometheus Architecture", duration: "32 min", type: "video", description: "Scraping, exporters, recording rules, and alerting rules." },
      { id: "mon-3", title: "PromQL Fundamentals", duration: "35 min", type: "video", description: "Instant vectors, range vectors, functions, and aggregation." },
      { id: "mon-4", title: "Grafana Dashboards", duration: "30 min", type: "video", description: "Data sources, panels, variables, and dashboard-as-code." },
      { id: "mon-5", title: "Alertmanager & On-Call", duration: "25 min", type: "video", description: "Routing, silencing, inhibition, and PagerDuty/Slack integration." },
      { id: "mon-6", title: "ELK / EFK Stack", duration: "35 min", type: "video", description: "Elasticsearch, Logstash/Fluentd, Kibana for log aggregation." },
      { id: "mon-7", title: "Distributed Tracing", duration: "28 min", type: "video", description: "OpenTelemetry, Jaeger, trace context propagation." },
      { id: "mon-8", title: "SLOs, SLAs & Error Budgets", duration: "22 min", type: "reading", description: "Service level objectives, error budgets, and reliability targets." },
      { id: "mon-9", title: "eBPF & Advanced Profiling", duration: "25 min", type: "reading", description: "Continuous profiling with Parca, eBPF observability, and perf." },
    ],
    labs: [
      { id: "mon-lab-1", title: "Prometheus + Grafana Stack", difficulty: "beginner", duration: "75 min", description: "Deploy the full monitoring stack with docker-compose." },
      { id: "mon-lab-2", title: "Custom Application Metrics", difficulty: "intermediate", duration: "90 min", description: "Instrument a Go/Python app with Prometheus client library." },
      { id: "mon-lab-3", title: "EFK Stack on Kubernetes", difficulty: "intermediate", duration: "120 min", description: "Deploy Elasticsearch, Fluentd, and Kibana on a K8s cluster." },
      { id: "mon-lab-4", title: "SLO Dashboard & Alerting", difficulty: "advanced", duration: "90 min", description: "Build a complete SLO dashboard with burn rate alerts." },
    ],
  },
  {
    id: "aws",
    ...
    totalHours: 14,
    lectures: [
      { id: "aws-1", title: "AWS Global Infrastructure", duration: "20 min", type: "video", description: "Regions, AZs, edge locations, and the shared responsibility model." },
      { id: "aws-2", title: "IAM: Identity & Access Management", duration: "35 min", type: "video", description: "Users, roles, policies, STS, and least privilege design." },
      { id: "aws-3", title: "VPC & Networking", duration: "38 min", type: "video", description: "VPCs, subnets, routing, NAT, VPN, and VPC peering." },
      { id: "aws-4", title: "EC2 & Auto Scaling", duration: "32 min", type: "video", description: "Instance types, AMIs, user data, ASG, and launch templates." },
      { id: "aws-5", title: "S3 & Storage Services", duration: "28 min", type: "video", description: "S3 storage classes, lifecycle, versioning, and CloudFront CDN." },
      { id: "aws-6", title: "RDS & Database Services", duration: "30 min", type: "video", description: "RDS, Aurora, DynamoDB, ElastiCache, and read replicas." },
      { id: "aws-7", title: "Lambda & Serverless", duration: "32 min", type: "video", description: "Functions, triggers, API Gateway, SAM, and cold starts." },
      { id: "aws-8", title: "EKS: Kubernetes on AWS", duration: "35 min", type: "video", description: "EKS clusters, node groups, Fargate, and AWS load balancers." },
      { id: "aws-9", title: "CloudWatch & Observability", duration: "25 min", type: "video", description: "Metrics, logs, alarms, X-Ray tracing, and dashboards." },
      ...
      { id: "aws-12", title: "High Availability Architecture", duration: "30 min", type: "video", description: "Multi-AZ, Route 53 failover, and disaster recovery patterns." },
    ],
    labs: [
  ...
  },
  {
    ...
    totalHours: 8,
    lectures: [
      { id: "ans-1", title: "Ansible Fundamentals", duration: "25 min", type: "video", description: "Agentless architecture, SSH, inventory, and ad-hoc commands." },
      { id: "ans-2", title: "Playbooks & Tasks", duration: "32 min", type: "video", description: "YAML structure, modules, handlers, and task ordering." },
      { id: "ans-3", title: "Variables & Templates", duration: "28 min", type: "video", description: "Variables precedence, Jinja2 templates, and lookup plugins." },
      { id: "ans-4", title: "Roles & Galaxy", duration: "30 min", type: "video", description: "Role structure, Ansible Galaxy, and community collections." },
      { id: "ans-5", title: "Dynamic Inventory", duration: "22 min", type: "video", description: "Cloud dynamic inventory, AWS EC2 plugin, and custom scripts." },
      { id: "ans-6", title: "Ansible Vault", duration: "18 min", type: "video", description: "Encrypting sensitive data, vault IDs, and CI/CD integration." },
      { id: "ans-7", title: "AWX & Automation Controller", duration: "30 min", type: "video", description: "Web UI, job templates, credentials, and scheduled jobs." },
  ...
  },
  {
    ...
    totalHours: 9,
    lectures: [
      { id: "kafka-1", title: "Kafka Architecture", duration: "30 min", type: "video", description: "Brokers, topics, partitions, offsets, and Zookeeper/KRaft." },
      { id: "kafka-2", title: "Producers & Consumers", duration: "32 min", type: "video", description: "Producer configs, consumer groups, rebalancing, and committing." },
      { id: "kafka-3", title: "Kafka Internals", duration: "28 min", type: "video", description: "Log compaction, retention, replication factor, and ISR." },
      { id: "kafka-4", title: "Kafka Streams", duration: "35 min", type: "video", description: "Stream processing, stateful operations, windowing, and KTable." },
      { id: "kafka-5", title: "Schema Registry & Avro", duration: "25 min", type: "video", description: "Schema evolution, Avro serialization, and Confluent Schema Registry." },
      { id: "kafka-6", title: "Kafka Connect", duration: "28 min", type: "video", description: "Source & sink connectors, transformations, and dead letter queues." },
      ...
      { id: "kafka-8", title: "Kafka on Kubernetes", duration: "30 min", type: "video", description: "Strimzi operator, StatefulSets, and persistent storage." },
  ...
  },
  {
    ...
    totalHours: 11,
    lectures: [
      { id: "az-1", title: "Azure Architecture Fundamentals", duration: "25 min", type: "video", description: "Regions, resource groups, subscriptions, and management groups." },
      { id: "az-2", title: "Azure Active Directory", duration: "32 min", type: "video", description: "Users, groups, RBAC, service principals, and managed identities." },
      { id: "az-3", title: "Virtual Machines & VMSS", duration: "28 min", type: "video", description: "VM sizes, images, availability sets, and scale sets." },
      { id: "az-4", title: "Azure Networking", duration: "35 min", type: "video", description: "VNets, subnets, NSGs, Azure Firewall, and VPN Gateway." },
      { id: "az-5", title: "Azure Kubernetes Service", duration: "38 min", type: "video", description: "AKS clusters, node pools, Azure CNI, and ACR integration." },
      { id: "az-6", title: "Azure DevOps Pipelines", duration: "35 min", type: "video", description: "Repos, Pipelines, Artifacts, and Boards for DevOps workflows." },
      { id: "az-7", title: "Storage & Databases", duration: "28 min", type: "video", description: "Blob Storage, Azure SQL, Cosmos DB, and Redis Cache." },
      { id: "az-8", title: "Azure Functions & Serverless", duration: "25 min", type: "video", description: "Functions, Logic Apps, Event Grid, and Service Bus." },
  ...
  },
  {
    ...
    totalHours: 10,
    lectures: [
      { id: "pg-1", title: "Prometheus Architecture & Setup", duration: "28 min", type: "video", description: "Components, service discovery, relabeling, and HA setup." },
      { id: "pg-2", title: "PromQL Mastery", duration: "40 min", type: "video", description: "Rate, irate, histogram_quantile, and advanced queries." },
      { id: "pg-3", title: "Recording & Alerting Rules", duration: "30 min", type: "video", description: "Precomputing metrics, alert syntax, and severity levels." },
      { id: "pg-4", title: "Alertmanager Configuration", duration: "28 min", type: "video", description: "Routes, receivers, silences, inhibition, and grouping." },
      { id: "pg-5", title: "Grafana Data Sources", duration: "22 min", type: "video", description: "Prometheus, Loki, Tempo, Elasticsearch, and MySQL." },
      { id: "pg-6", title: "Dashboard Design Principles", duration: "30 min", type: "video", description: "USE, RED, and GOLDEN signal methods for useful dashboards." },
      { id: "pg-7", title: "Grafana Loki", duration: "28 min", type: "video", description: "LogQL, log streams, labels, and Promtail configuration." },
      { id: "pg-8", title: "Grafana Tempo & Traces", duration: "25 min", type: "video", description: "Trace exploration, trace-to-logs correlation, and exemplars." },
