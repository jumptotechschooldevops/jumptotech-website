...
export const modules: Module[] = [
  ...
  },
  {
    ...
    lectures: [
      { id: "mon-1", title: "Observability Pillars", duration: "20 min", type: "reading", description: "Metrics, logs, and traces — the three pillars explained." },
      { id: "mon-2", title: "Prometheus Architecture", duration: "32 min", type: "reading", description: "Scraping, exporters, recording rules, and alerting rules." },
      { id: "mon-3", title: "PromQL Fundamentals", duration: "35 min", type: "reading", description: "Instant vectors, range vectors, functions, and aggregation." },
      { id: "mon-4", title: "Grafana Dashboards", duration: "30 min", type: "reading", description: "Data sources, panels, variables, and dashboard-as-code." },
      { id: "mon-5", title: "Alertmanager & On-Call", duration: "25 min", type: "reading", description: "Routing, silencing, inhibition, and PagerDuty/Slack integration." },
      { id: "mon-6", title: "ELK / EFK Stack", duration: "35 min", type: "reading", description: "Elasticsearch, Logstash/Fluentd, Kibana for log aggregation." },
      { id: "mon-7", title: "Distributed Tracing", duration: "28 min", type: "reading", description: "OpenTelemetry, Jaeger, trace context propagation." },
  ...
  },
  {
    ...
    color: "#ff9900",
    coverImage: "https://images.unsplash.com/photo-1523474253046-8cd2748b5fd2?w=800",
    lectureCount: 12,
    labCount: 6,
    totalHours: 14,
